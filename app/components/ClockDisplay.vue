...
<template>
  <div class="text-center">
    ...
    <div
      class="text-5xl font-mono bg-linear-to-r from-blue-500 to-purple-600 text-white p-6 rounded-lg shadow-lg"
    >
      {{ currentTime }}
    </div>
    ...
    <div class="mt-2 text-sm text-gray-500">Обновлено: {{ lastUpdate }}</div>
  </div>
</template>
